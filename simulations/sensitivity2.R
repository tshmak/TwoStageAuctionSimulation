...
filename <- Rfilename("sensitivity2", seed="prompt")
1000

# dir.create("sensitivity2")
...
# K <- c(8,Inf); Dip <- c(0, 0.5, 1) # Testing
# K <- c(Inf); Dip <- c(0.8) # Testing
